		...
		<div class="space-y-2">
			<div class="flex items-center gap-2">
				<Button
					...
					size="icon"
					class="shrink-0"
					disabled={disabled || collectionsState.entries.length >= collectionsState.maxCollections}
				...
				<div class="relative flex-1">
					<Input
						...
						class={cn(
							'pr-10',
							entry.status === 'valid' && 'border-green-500 focus-visible:ring-green-500/20',
							entry.status === 'invalid' && 'border-destructive focus-visible:ring-destructive/20'
						)}
